...
export default function Home() {
  ...
  const [connectionStatus, setConnectionStatus] = useState('checking'); // 'checking', 'ready', 'error'
          ...
          <div className="max-w-3xl mx-auto px-6 py-4">
            <form onSubmit={handleSendMessage} className="relative">
              <textarea
                ...
                placeholder={apiKey ? "Type a message..." : "Add API key in Settings to start..."}
                disabled={isLoading}
                rows={1}
        ...
        {showSettings && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div 
              ...
              onClick={() => apiKey ? setShowSettings(false) : null}
            />
            ...
            <div className="relative w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-2xl p-6 shadow-2xl">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:opacity-90 text-sm font-medium transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Save & Connect
                </button>
              </div>
